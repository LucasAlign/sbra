...
| `introductions`, `introduction_participants`, `referrals` | Origin context, involved people and represented organizations; consent/status transitions. Referral points are derived from Sent/Won outcomes. | Participants; explicit optional reporting |
